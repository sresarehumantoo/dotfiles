// Vendored unmodified from sahaj-b/ghostty-cursor-shaders (MIT).
// https://github.com/sahaj-b/ghostty-cursor-shaders
//
// Note: THRESHOLD_MIN_DISTANCE below is left on upstream's units (cursor
// widths) unlike cursor_warp.glsl, because here lineLength also feeds the tail
// geometry — changing its units would alter the look, not just the gate.
//
